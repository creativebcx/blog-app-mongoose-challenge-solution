...
function generateTitle() {
  const title = ['My Day', 'Your Day', 'Their Day'];
...
function generateBlogPostData() {
  return {
    author: {
      firstName: faker.author.generateAuthorName(),
      lastName: faker.author.generateAuthorName()
    },
    title: generateTitle(),
...
describe('BlogPost API resource', function() {
    ...
    it('should add a new Blog Post', function() {
      ...
      return chai.request(app)
        ...
        .then(function(res) {
          ...
          mostRecentTitle = newBlogPost.title.sort(
            (Stuff, Morestuff) => Morestuff.date - Stuff.date)[0].title;

          res.body.title.should.equal(mostRecentTitle);
  ...
  describe('PUT endpoint', function() {
    ...
    it('should update fields you send over', function() {
      const updateData = {
        author: {
          firstName: 'Superdupper',
          lastName: 'lastlastlast'
        },
        title: 'booya',
